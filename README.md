...
This is a `java` application for booking hotel rooms which I developed for the Java Fundamentals section of Udacity's Cognizant Full Stack Developer Train to Hire Nanodegree.
...
You may run the project by executing the HotelApplication.java file. 
...
> Example: If the customers date range search is 12/1/2022 – 12/5/2022 and all rooms are booked, the system will search again for recommended rooms using the date range 12/8/2022 - 12/12/2022. If there are no recommended rooms, the system will not return any rooms.
